...
x1 = float(input("Enter x1 corrdinates: "))
y1 = float(input("Enter y1 corrdinates:  "))
x2 = float(input("Enter x2 corrdinates: "))
y2 = float(input("Enter y2 corrdinates: "))
